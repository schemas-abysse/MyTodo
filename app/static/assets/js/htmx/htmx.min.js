(function (e, t) {
    ...
    return function () {
                    ...
                    if (o === "]") {
                        ...
                        if (n === 0) {
                            ...
                            try {
                                ...
                                ne(J().body, "htmx:syntax:error", {error: e, source: i});
                                return null
                            }
                        }
                    } else if (o === "[") {
        ...
        function Ge(e, t, r) {
            ...
            n.timeout = setTimeout(function () {
                if (ee(e) && n.cancelled !== true) {
                    if (!Qe(r, Lt("hx:poll:trigger", {triggerSpec: r, target: e}))) {
                        t(e)
                    }
                    Ge(e, t, r)
                }
        ...
        function Qe(e, t) {
            ...
            if (r) {
                try {
                    ...
                    ne(J().body, "htmx:eventFilter:error", {error: e, source: r.source});
                    return true
                }
            }
            return false
        ...
        function kt(e, t, r, n) {
            ...
            while (i.length > 0) {
                try {
                    ...
                    ne(J().body, "htmx:historyCacheError", {cause: e, cache: i});
                    i.shift()
                }
            }
        }
        ...
        function Dt() {
            ...
            if (!r) {
                ie(J().body, "htmx:beforeHistorySave", {path: t, historyElt: e});
                kt(t, Mt(e), J().title, window.scrollY)
            }
            if (z.config.historyEnabled) history.replaceState({htmx: true}, J().title, window.location.href)
        }
        ...
        function jt(a) {
            ...
            e.onload = function () {
                if (this.status >= 200 && this.status < 400) {
                    ...
                    Bt(r.tasks);
                    Nt = a;
                    ie(J().body, "htmx:historyRestore", {path: a, cacheMiss: true, serverResponse: this.response})
                } else {
        ...
        function Gt(e, t) {
            if (e.willValidate) {
                ...
                if (!e.checkValidity()) {
                    ...
                    ie(e, "htmx:validation:failed", {message: e.validationMessage, validity: e.validity})
                }
            }
        }
        ...
        function ar(e, t) {
            ...
            if (t.show) {
                ...
                if (t.show === "top" && (r || i)) {
                    i = i || r;
                    i.scrollIntoView({block: "start", behavior: z.config.scrollBehavior})
                }
        ...
        function dr(e, t, r) {
            ...
            if (r) {
                if (r instanceof Element || A(r, "String")) {
                    return ae(e, t, null, null, {targetOverride: s(r), returnPromise: true})
                } else {
        ...
        function ae(e, t, n, r, i, M) {
            ...
            if (y) {
                var b = prompt(y);
                if (b === null || !ie(n, "htmx:prompt", {prompt: b, target: l})) {
                    K(a);
                    x();
                    return s
                }
            ...
            var k = {
                ...
                etc: i,
                boosted: H,
                pathInfo: {requestPath: t, finalRequestPath: N || t, anchor: A}
            };
            m.onload = function () {
                try {
                    var e = vr(n);
            ...
            Q(["loadstart", "loadend", "progress", "abort"], function (t) {
                Q([m, m.upload], function (e) {
                    e.addEventListener(t, function (e) {
                        ie(n, "htmx:xhr:" + t, {lengthComputable: e.lengthComputable, loaded: e.loaded, total: e.total})
                    })
                })
            });
        ...
        function pr(s, l) {
                ...
                var o = function () {
                    try {
                        ...
                        if (t.elt && !ee(t.elt) && t.elt.id) {
                            ...
                            var i = {preventScroll: c.focusScroll !== undefined ? !c.focusScroll : !z.config.defaultFocusScroll};
                            if (r) {
                        ...
                        var o = function () {
                            ...
                            if (h.type) {
                                if (h.type === "push") {
                                    Xt(h.path);
                                    ie(J().body, "htmx:pushedIntoHistory", {path: h.path})
                                } else {
                                    Ft(h.path);
                                    ie(J().body, "htmx:replacedInHistory", {path: h.path})
                                }
                            }
            ...
            if (n) {
                ne(s, "htmx:responseError", te({error: "Response Status Error Code " + u.status + " from " + l.pathInfo.requestPath}, l))
            }
        }
        ...
        Sr(function () {
            ...
            window.onpopstate = function (e) {
                if (e.state && e.state.htmx) {
                    Ut();
                    Q(t, function (e) {
                        ie(e, "htmx:restored", {document: J(), triggerEvent: ie})
                    })
                } else {
                    if (r) {
                        r(e)
